  ...
  <div>
    <div class="is-task" :id="taskData.tileNo">
      <div class="is-directive">
        <text class="title is-json is-text-red" :class="{ 'has-text-grey': task_completed || completedBefore }"
          >
          {{ taskData.title }}
        </text>
        ...
        <div class="mt-5" 
          ...
          >
          <text class="is-size-6 has-text-justified"
        ...
        <div v-else>
          ...
          <div class="columns is-hcentered mt-5">
            <img class="image is-hcentered rotate" style="width: 100px"
