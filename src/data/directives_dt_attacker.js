const Task2 =
{
  ...
  blanks: [
    {
      responseActionDescription: "name",
      flag: "FIREWALL-WARNING",
      placeholder: "title of the Event Type",
      hintDescription: "Use the search function of the SIEM dashboard to look for the Event Type. Maybe 'Firewall' helps ;)",
      stage: 1,
    ...
    {
      responseActionDescription: "plugin_sid",
      flag: "9",
